...
public class QuizNuit : MonoBehaviour
{
...
public GameObject screen_1;
  ...
  public GameObject lights;
    ...
    private void OnTriggerEnter(Collider other){
        ...
        playeranim.SetInteger("nuit",2);GameObject.Find("Main Camera").GetComponent<Camera>().clearFlags = CameraClearFlags.SolidColor;
        }
