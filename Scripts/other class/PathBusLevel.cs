...
public class PathBusLevel : MonoBehaviour
...
float movementStep = movementSpeed * Time.deltaTime;
       ...
       // Debug.DrawRay(transform.position, transform.forward * 50f, Color.green, 0f); //Draws a ray forward in the direction the enemy is facing
        ...
        transform.position = Vector3.MoveTowards(transform.position, targetNode.position, movementStep);if(marcher==false) {movementSpeed=0;}
    }
   ...
   public void Marcher(){StartCoroutine(Wait());
